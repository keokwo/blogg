...
export const STACKS: stacksProps = {
  Flowgorithm: <FcWorkflow size={iconSize} className='text-blue-500' />,
  PHP: <SiPhp size={iconSize} className='text-blue-500' />,
  JavaScript: <SiJavascript size={iconSize} className='text-yellow-400' />,
  Java: <FaJava size={iconSize} className='text-red-500' />,
  ...
  CodeIgniter: <SiCodeigniter size={iconSize} className='text-red-500' />,
  Canva: <SiCanva size={iconSize} className='text-blue-500' />,
